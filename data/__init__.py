...
class FundamentalDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            window_size (int): The size of the window in years (default is DEFAULTS.window_size_years).
            dtype (torch.dtype): The data type for torch (default is DEFAULTS.dtype).
            padding_val (torch.tensor): The padding value for torch tensor (default is DEFAULTS.padding_val).
            freq (DEFAULTS.FREQ): The frequency of the data (default is "Y").
        """
