...
class BaseAutoEncoder(nn.Module, ABC):
    ...
    def __init__(
        ...
        Args:
            ...
            dtype (torch.dtype?): Data type for computation. Defaults to torch.float32.
        """
        super().__init__()
        ...
        def create_decoder(decoder_layer: nn.TransformerDecoderLayer, num_layers: int):
            ...
            Returns:
                nn.TransformerDecoder: A transformer decoder with the specified decoder layer and number of layers.
            """
        ...
        def create_linear_encoder(dim: int, window_size: int):
            ...
            This function creates a linear encoder using a sequence of linear layers and batch normalization.
