...
class BaseAutoEncoder(nn.Module, ABC):
    ...
    def __init__(
        ...
        def create_linear_encoder(dim: int, window_size: int):
            ...
            This function creates a linear encoder using a sequence of neural network layers including flattening, batch normalization,
            and multiple linear layers to reduce the input dimension to the specified encoding dimension.
            ...
            Returns:
                nn.Sequential: The linear encoder neural network model.
            """
